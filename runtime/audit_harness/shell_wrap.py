...
from runtime.audit_harness.recorder import StdoutRecorder
...
def main():
    ...
    try:
        ...
        print("SAPIANTA — HDS Chat Shell + HOI CLI + AUDIT HARNESS")
        print("Audit: stdout capture ENABLED")
